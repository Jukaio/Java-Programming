...
public class WallSensorsComponent extends Component
{
    ...
    {
        super(p_entity);
        m_offset_x = m_offset_x = XML.parse_float(p_data,
                                                  "offset_x");
    }
    ...
    public static void update_position(WallSensorsComponent p_sensor)
    {
        ...
        final float x = p_sensor.get_entity().get_position().m_x.floatValue() + 0;
        final float y = p_sensor.get_entity().get_position().m_y.floatValue() + 0;
        ...
        p_sensor.m_wall.m_start.y = (int) (y);
        p_sensor.m_wall.m_end.x = (int) (x + half_w - p_sensor.m_offset_x);
        p_sensor.m_wall.m_end.y = (int) (y);
    }
}
