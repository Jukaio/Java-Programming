...
public class GroundSensorsComponent extends Component
{
    ...
    protected GroundSensorsComponent(Entity p_entity, World p_world, Element p_data)
    {
        super(p_entity);
    ...
    private static void update_position(GroundSensorsComponent p_sensor)
    {
        ...
        final float x = p_sensor.get_entity().get_position().m_x.floatValue();
        final float y = p_sensor.get_entity().get_position().m_y.floatValue();
        ...
        p_sensor.m_ground_left.m_start.y = (int) (y + p_sensor.m_offset_y - half_h);
        ...
        p_sensor.m_ground_center.m_start.y = (int) (y - half_h + p_sensor.m_offset_x);
        ...
        p_sensor.m_ground_right.m_start.y = (int) (y - half_h + p_sensor.m_offset_y);
