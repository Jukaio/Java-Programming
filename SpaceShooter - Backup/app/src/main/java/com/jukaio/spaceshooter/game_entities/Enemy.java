...
{
    Bitmap_Component m_bitmap_component;
    ...
    {
        super(p_other);
        m_bitmap_component = new Bitmap_Component(p_other.m_bitmap_component);
    ...
    {
        super(p_active);
        m_bitmap_component = new Bitmap_Component(m_game, this, p_bitmap_id, p_scale_ratio, BASE_COLOR);
                       ...
                       Paint p_paint)
    {
        ...
        m_bitmap_component.render(this, p_canvas, p_paint);
    }
